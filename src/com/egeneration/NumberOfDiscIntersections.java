...
public class NumberOfDiscIntersections {
    ...
    public static int numberOfDiscIntersections1(int[] A) {
        /*Score: 81%*/
    ...
    /*2. Improve solution. Time complexity is O(N*log(N)) or O(N).
    ...
    public static void main(String[] args) {
        System.out.println(numberOfDiscIntersections2(new int[] {1,5,2,1,4,0}));
        // { 1, 5, 2, 1, 4, 0 }, 11 },
        // { 2, 1, 0, 4 }, 6 },
        // {  }, 0 },
        // { 1 }, 0 },
